...
def ParseArgs():
	...
	parser.add_argument('--cdreg', default=1e-2, type=float, help='contrastive distillation reg weight')
	parser.add_argument('--softreg', default=1, type=float, help='soft-target-based distillation reg weight')
	parser.add_argument('--screg', default=1, type=float, help='self-contrastive reg weight')
	...
	parser.add_argument('--tempsoft', default=0.03, type=float, help='temperature for soft binary classification in distillation')
	parser.add_argument('--tempcd', default=0.1, type=float, help='temperature for contrastive distillation')
	parser.add_argument('--tempsc', default=1, type=float, help='temperature for self-contrastive learning')
